...
require (
	...
	github.com/erigontech/interfaces v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/ianlancetaylor/cgosymbolizer v0.0.0-20251106193036-e159b5929349 // indirect
