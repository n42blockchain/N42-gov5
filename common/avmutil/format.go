...
//
// AVM human-readable formatting helpers. PrettyDuration trims
// sub-millisecond precision from time.Duration strings, while
// PrettyAge rounds a timestamp to the largest significant unit
// (years, months, weeks, days, hours, minutes, seconds) using the
// ageUnits table for log and RPC display.
