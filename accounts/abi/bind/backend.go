...
//
// Backend interfaces the generated bindings talk to.
// Defines ContractCaller, PendingContractCaller, ContractTransactor,
// DeployBackend, ContractFilterer and the union ContractBackend used
// by BoundContract. Declares ErrNoCode, ErrNoPendingState and
// ErrNoCodeAfterDeploy sentinels and abstracts rpc, simulated and
// in-process clients behind a common read/write/filter surface.
