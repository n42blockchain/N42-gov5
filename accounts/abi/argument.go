...
//
// Typed ABI argument list for method inputs, outputs and event topics.
// Argument pairs a Name and Type with an Indexed flag and supports
// UnmarshalJSON via ArgumentMarshaling. Arguments provides Pack,
// PackValues, Unpack, UnpackValues, UnpackIntoMap and Copy helpers,
// including NonIndexed() filtering for event decoding.
