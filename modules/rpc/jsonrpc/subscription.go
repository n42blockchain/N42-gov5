...
//
// JSON-RPC subscription plumbing and random ID generation.
// ID is a pseudo-random hex string produced by a crypto/rand backed
// generator (globalGen). Sentinel errors ErrNotificationsUnsupported
// and ErrSubscriptionNotFound cover the subscription lifecycle
// failure modes. NewID returns a fresh subscription identifier.
