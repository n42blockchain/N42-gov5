...
func (m mdbxPieceCompletion) Set(pk metainfo.PieceKey, b bool) error {
	...
	//  - Bad  piece on disk and recent "incomplete" db marker lost. No Self-Heal. Means: can't afford losing recent "incomplete" markers.
	// FYI: Fsync of torrent pieces happening before storing db markers: https://github.com/anacrolix/torrent/blob/master/torrent.go#L2026
	//
	// Mainnet stats:
	//  call amount 2 minutes complete=100K vs incomplete=1K
