...
// Source: github.com/n42blockchain/N42/lib/gointerfaces/remote (interfaces: KV_StateChangesClient)
//
// Generated by this command:
//
//	mockgen -typed=true -destination=./kv_state_changes_client_mock.go -package=remote . KV_StateChangesClient
//
