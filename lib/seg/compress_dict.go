...
// DictionaryBuilder collects and sorts dictionary patterns by their frequency score.
...
// PatternHeap is priority queue of patterns for building
// Huffman tree to determine efficient coding.
