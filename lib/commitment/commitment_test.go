...
func hexDec(s string) []byte { b, _ := hex.DecodeString(strings.TrimPrefix(s, "0x")); return b }
...
func TestBranchData_ReplacePlainKeys_PartialChange(t *testing.T) {
	...
	replaced, err := BranchData(types.CopyBytes(enc)).ReplacePlainKeys(
		make([]byte, 0, len(enc)),
		func(key []byte, isStorage bool) ([]byte, error) {
			origKeys = append(origKeys, keyRecord{types.CopyBytes(key), isStorage})
			if isStorage {
...
func TestUpdates_TouchPlainKey(t *testing.T) {
	...
	upds := []tc{
		{hexDec("c17fa85f22306d37cec90b0ec74c5623dbbac68f"), []byte("value1")},
		{hexDec("553bba1d92398a69fbc9f01593bbc51b58862366"), []byte("value0")},
		{hexDec("553bba1d92398a69fbc9f01593bbc51b58862366"), []byte("value8")},
		{hexDec("2452345febefe553bba1d92398a69fbc9f01593b"), []byte("value8")},
		{hexDec("ffffffffffff8a69fbc9f01593bbc51b58862366"), []byte("value8")},
		{hexDec("553bba1d92398a69fbc9f01593bbceeeeeeeee66"), []byte("value8")},
		{hexDec("553bba1d9239aaaaaaaaa01593bbc51b58862366"), []byte("value8")},
		{hexDec("553bba1d92398a69fbc9f01593bb777777777777"), []byte("value8")},
		{hexDec("5cccccccccccca69fbc9f01593bbc51b58862366"), []byte("value8")},
		{hexDec("553bba1d92398a69fbc9feeeeeeee51b58862366"), []byte("value8")},
		{hexDec("553bba1d9bbbbbbbbbbbbb1593bbc51b58862366"), []byte("value8")},
		{hexDec("553bba1d9ffffffffffff01593bbc51b5aaaaaaa"), []byte("value8")},
		{hexDec("97c780315e7820752006b7a918ce7ec023df263a87a715b64d5ab445e1782a760a974f8810551f81dfb7f1425f7d8358332af195"), []byte("value1")},
		{hexDec("97c780315e7820752006b7a918ce7ec023df263a87a715b64d5ab445e1782a760a974f881055fffffffff1425f7d8358332af195"), []byte("value1")},
		{hexDec("97c780315e7820752006b7a918ce7ec023df263a87a715b64d5ab445e1782a760a974f8810551f81dfb7eeeeeeeeeeeeeeeeee95"), []byte("value1")},
		{hexDec("97c780315e7820752006b7a918ce7ec023df263a87a715b64d5ab445e1782a760a974aaaaaaa1f81dfb7f1425f7d8358332af195"), []byte("value1")},
		{hexDec("97c780315e7820752006b7a918ce7ec023df263a87a715b64d5ab445e1782a760a974f8810551f81dfb7f1425f7d835838888885"), []byte("value1")},
	}
