...
//}
//
//func (cell *BinaryCell) accountForHashing(buffer []byte, storageRootHash types.Hash) int {
//	balanceBytes := 0
...
//}
//
//func (bph *BinPatriciaHashed) extensionHash(key []byte, hash []byte) (types.Hash, error) {
...
//			} else {
//				storageRootHash = *(*types.Hash)(EmptyRootHash)
//			}
//		}
//		var valBuf [128]byte
