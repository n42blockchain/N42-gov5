...
import (
	...
	"github.com/n42blockchain/N42/lib/txpool"
...
func AllComponents(ctx context.Context, cfg txpoolcfg.Config, cache kvcache.Cache, newTxs chan types.Announcements, chainDB kv.RoDB,
	...
	glamsterdamTime := chainConfig.GlamsterdamTime

	txPool, err := txpool.New(newTxs, chainDB, cfg, cache, *chainID, shanghaiTime, agraBlock, cancunTime, pragueTime, osakaTime, glamsterdamTime,
