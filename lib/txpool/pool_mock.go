...
// Source: github.com/n42blockchain/N42/lib/txpool (interfaces: Pool)
//
...
import (
	...
	remote "github.com/n42blockchain/N42/lib/gointerfaces/remote"
	kv "github.com/n42blockchain/N42/lib/kv"
	txpoolcfg "github.com/n42blockchain/N42/lib/txpool/txpoolcfg"
	types "github.com/n42blockchain/N42/lib/types"
...
func (m *MockPool) AddLocalTxs(arg0 context.Context, arg1 types.TxSlots, arg2 kv.Tx) ([]txpoolcfg.DiscardReason, error) {
	m.ctrl.T.Helper()
...
// Return rewrite *gomock.Call.Return
func (c *MockPoolFilterKnownIdHashesCall) Return(arg0 types.Hashes, arg1 error) *MockPoolFilterKnownIdHashesCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}
...
func (mr *MockPoolMockRecorder) OnNewBlock(arg0, arg1, arg2, arg3, arg4, arg5 any) *MockPoolOnNewBlockCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "OnNewBlock", reflect.TypeOf((*MockPool)(nil).OnNewBlock), arg0, arg1, arg2, arg3, arg4, arg5)
