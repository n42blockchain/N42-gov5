...
var (
	root          *logger
	StdoutHandler = StreamHandler(os.Stdout, TerminalFormatNoColor())
	StderrHandler = StreamHandler(os.Stderr, TerminalFormatNoColor())
)
...
// The following functions call the underlying logger directly instead of the exported methods (logger.Debug,
