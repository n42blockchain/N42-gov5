...
// Ported from erigon cl/persistence/state/epoch_data.go (import paths rewritten
// to N42's internal/cl/*). Part of the Caplin merge (#31): state_accessors
// foundation for antiquary + historical_states_reader.
...
func (m *EpochData) ReadFrom(r io.Reader) error {
	...
	length := binary.LittleEndian.Uint64(lenB)
