...
// Ported from erigon cl/persistence/state/slot_data.go (import paths rewritten
// to N42's internal/cl/* + depshim/common). Part of the Caplin merge (#31):
// state_accessors foundation that antiquary + historical_states_reader build on.
