...
//
// Hash vector unit for the solid package.
// Defines the hashVector types.
// Provides constructors NewHashVector.
// Exports helpers such as NewHashVector, Append, MarshalJSON, and
// UnmarshalJSON.
