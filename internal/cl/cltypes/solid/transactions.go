...
//
// Transactions unit for the solid package.
// Defines the TransactionsSSZ types.
// Provides constructors NewTransactionsSSZFromTransactions.
// Exports helpers such as UnmarshalJSON, MarshalJSON, Clone, and Static.
