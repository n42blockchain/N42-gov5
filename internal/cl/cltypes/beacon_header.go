...
//
// Beacon header unit for the cltypes package.
// Defines the BeaconBlockHeader and SignedBeaconBlockHeader types.
// Exports helpers such as Copy, EncodeSSZ, DecodeSSZ, and HashSSZ.
