...
// Ported from erigon cl/antiquary/state_antiquary.go for the Caplin merge (#31); imports
// rewritten to internal/cl/* + N42 DB-fallback shims (downloader/snaptype/
...
import (
	...
	"github.com/n42blockchain/N42/internal/cl/clparams/initial_state"
	...
	"github.com/n42blockchain/N42/internal/cl/depshim/snaptype"
	...
	"github.com/n42blockchain/N42/internal/cl/persistence/state/historical_states_reader"
