...
//
// Util unit for the shuffling package.
// Exports helpers such as ComputeShuffledIndex,
// ComputeShuffledIndexPreInputs, GetSeed, and ComputeShuffledIndicies.
...
import (
	...
	"github.com/n42blockchain/N42/internal/cl/utils/eth2shuffle"
