...
//
// Cache accessors unit for the state package.
// Exports helpers such as GetActiveValidatorsIndices, GetTotalActiveBalance,
// ComputeCommittee, and GetBeaconProposerIndex.
