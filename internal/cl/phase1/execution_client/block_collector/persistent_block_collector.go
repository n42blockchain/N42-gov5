...
// Ported from erigon cl/phase1/execution_client/block_collector/persistent_block_collector.go for the
// Caplin merge (#31); imports rewritten to internal/cl/* + N42 shims; MDBX
// construction adapted to N42's mdbx.NewMDBX builder.
...
import (
	...
	"github.com/n42blockchain/N42/internal/cl/depshim/dir"
...
func openPersistentDB(ctx context.Context, logger log.Logger, persistDir string) (kv.RwDB, error) {
	return mdbx.NewMDBX(logger).Label(kv.CaplinDB).
		Path(persistDir).
