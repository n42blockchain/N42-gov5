...
//
// Aggregate signature collection and verification for APOS consensus.
// Defines the AggSign wire type binding a block number, state root and
// BLS signature from a verifier, plus a package-level sigChannel fed by
// the admin RPC and a validVerifiers allowlist keyed by public key hex.
