...
//
// Server-response validation for compressed snap-sync batches.
// validateAccountBatch and siblings check that metadata EntryCount,
// key length, ascending order and [startKey, endKey) range invariants
// hold, returning ErrBatchEmpty, ErrBatchKeyOrder or related errors.
