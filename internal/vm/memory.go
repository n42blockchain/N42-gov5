...
// ErrInvalidMemoryAccess is returned when memory access is out of bounds.
...
// Returns ErrInvalidMemoryAccess if the memory hasn't been resized to fit the data.
...
// GetCopy returns a copy of the data at offset + size as a new slice.
