...
func TestHistoryStorageCode(t *testing.T) {
	...
	const want = "3373fffffffffffffffffffffffffffffffffffffffe14604657602036036042575f35600143038111604257611fff81430311604257611fff9006545f5260205ff35b5f5ffd5b5f35611fff60014303065500"
	if got := types.Bytes2Hex(HistoryStorageCode); got != want {
		t.Fatalf("HistoryStorageCode = %s, want %s", got, want)
	}
}

func TestWithdrawalRequestQueueCode(t *testing.T) {
	if len(WithdrawalRequestQueueCode) == 0 {
		t.Fatal("WithdrawalRequestQueueCode should not be empty")
	}
	const want = ""
	if got := types.Bytes2Hex(WithdrawalRequestQueueCode); got != want {
		t.Fatalf("WithdrawalRequestQueueCode = %s, want %s", got, want)
	}
}

func TestConsolidationRequestQueueCode(t *testing.T) {
	if len(ConsolidationRequestQueueCode) == 0 {
		t.Fatal("ConsolidationRequestQueueCode should not be empty")
	}
	const want = ""
	if got := types.Bytes2Hex(ConsolidationRequestQueueCode); got != want {
		t.Fatalf("ConsolidationRequestQueueCode = %s, want %s", got, want)
	}
}
