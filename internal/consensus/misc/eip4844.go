...
//
// EIP-4844 blob gas header verification for Cancun.
// VerifyEIP4844Header checks that BlobGasUsed stays below
// params.MaxBlobGasPerBlock, is an exact multiple of
// BlobTxBlobGasPerBlob, and that ExcessBlobGas is correctly derived
// from the parent header values. Core gatekeeper for blob-carrying
// transactions entering the canonical chain.
