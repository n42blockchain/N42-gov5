...
func (al accessList) accessList() transaction.AccessList {
	acl := make(transaction.AccessList, 0, len(al))
	for addr, slots := range al {
		tuple := transaction.AccessTuple{Address: addr, StorageKeys: []common.Hash{}}
...
func NewAccessListTracer(acl transaction.AccessList, from, to common.Address, precompiles []common.Address) *AccessListTracer {
...
func (a *AccessListTracer) AccessList() transaction.AccessList {
