...
//
// MEV-Boost block auction: the Auction type compares a locally built
// block against external builder bids fetched through RelayClient and
// picks the most profitable candidate for proposal. A configurable
// minBidWei threshold guards against accepting sub-economic relay
// bids; CompareAndSelect performs the policy decision and logs the
// winner via zap.
