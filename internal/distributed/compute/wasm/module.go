...
//
// ModuleRegistry stores compiled WASM modules. Each Module carries its
// Keccak256 bytecode hash, exported function names, size and
// RegisteredAt timestamp. Register assigns the hash from raw bytes so
// tasks can reference modules by a stable content address.
