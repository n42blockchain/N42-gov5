...
func (m *MockStateDB) Selfdestruct6780(addr types.Address, beneficiary types.Address) {}
func (m *MockStateDB) Selfdestruct8246(addr types.Address)                            {}
...
func (m *MockStateDB) HasNonEmptyStorage(addr types.Address) bool {
	return false
}
